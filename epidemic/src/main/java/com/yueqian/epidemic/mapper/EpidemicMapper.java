...
public interface EpidemicMapper {
    ...
    @Insert(value = "INSERT into epidemic(province_id,data_year,data_month,data_day,affirmed,suspected,isolated,dead,cured,user_id,input_date) values(#(provinceId},#{dataYear},#{dataMonth},#{dataDay},#{affirmed},#{suspected}" +
