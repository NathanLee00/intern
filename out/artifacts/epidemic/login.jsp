...
<head>
    ...
    <!-- 上述3个meta标签*必须*放在最前面，任何其他内容都*必须*跟随其后！ -->c
    <title>登录页面</title>
        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            <form action="${pageContext.request.contextPath}/user/login" method="post" class="form-horizontal">
                <div class="form-group">
                    <label class="col-md-3 control-label" for="userAccount">账号：</label>
                    <div class="col-md-8"><input type="text" name="userAccount" id="userAccount" class="form-control"/></div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label" for="userPassword">密码：</label>
                    <div class="col-md-8"> <input type="password" name="userPassword" id="userPassword" class="form-control"/></div>
                </div>
                <div class="form-group">
